{
  ...
  first = "/nfs/dust/cms/user/karavdia/GridControl_JEC/JMEValidatorTree_13TeV_DATA_RunIID_Cert_246908-260627_v2_13TeV_PromptReco_Collisions15_25ns_JSON_Fall15_25nsV1_DATA/dataJetHTRun2015D16Dec_";
  second = ".root";
  std::string tmp;
  ...
  //  for (int i=0; i<226; i++){
    ...
    if(!gSystem->GetPathInfo(tmp_,id,size,flags,mt)){ 
      ...
      convert(first+tmp+second,"/nfs/dust/cms/user/karavdia/BaconTrans_JEC/AK4PFCHS/JMEValidatorTree_13TeV_DATA_RunIID_Cert_246908-260627_v2_13TeV_PromptReco_Collisions15_25ns_JSON_Fall15_25nsV1_DATA/dataJetHTRun2015D16Dec_"+tmp+".root","AK4PFCHS");
    }
  }
}
